...
class Network(object):
    ...
    def feedforward2(self, a):
        """
        Feed forward implementation for fully matrix based backprop algorithm.
        """
        zs = []
        activations = [a]
    ...
    def update_mini_batch2(self, mini_batch, eta):
        """
        Update the network's weights and biases using a fully matrix
        based backprop algorithm (see backprop2).
        """
    ...
    def backprop2(self, x, y):
        """
        Simultaneously compute derivatives for all (x, y) in minibatch.
        """
